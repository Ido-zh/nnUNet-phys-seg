...
from nnunet.training.network_training.nnUNetTrainerV2_Perfusion import nnUNetTrainerV2_Perfusion
...
class nnUNetTrainerV2_PerfusionRC(nnUNetTrainerV2_Perfusion):
