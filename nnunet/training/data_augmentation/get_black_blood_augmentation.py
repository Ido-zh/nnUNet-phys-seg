...
from nnunet.training.data_augmentation.virtual_mri import BlackBloodImagingAugmentation, SplitDataKeyTransform
try:
...
def get_moreDA_bb_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
    ...
    split_key_trans = SplitDataKeyTransform(data_key='data',)
    bb_trans = BlackBloodImagingAugmentation()
    tr_transforms = [split_key_trans, bb_trans]
    ...
    tr_transforms.append(GaussianNoiseTransform(noise_variance=(0, 2), p_per_sample=0.1))
    ...
    tr_transforms.append(ContrastAugmentationTransform(p_per_sample=0.3))
