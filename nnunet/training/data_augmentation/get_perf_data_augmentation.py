...
from nnunet.training.data_augmentation.virtual_mri import PerfusionImagingAugmentation, SplitDataKeyTransform
try:
...
def get_moreDA_perf_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
    ...
    bb_trans = PerfusionImagingAugmentation()
    ...
    tr_transforms.append(GaussianNoiseTransform(p_per_sample=0.1, noise_variance=(0, 0.2)))
