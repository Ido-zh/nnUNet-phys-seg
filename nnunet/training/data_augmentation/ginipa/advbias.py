"""
nnunetlite.training.augmentations.ginipa.advbias

For pseudo-correlation map generation.
    - Code borrowed from https://github.com/cheng-01037/Causality-Medical-Image-Domain-Generalization/tree/main/biasfield_interpolate_cchen
"""
import torch
